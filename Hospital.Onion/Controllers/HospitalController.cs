...
namespace Hospital.Onion.Controllers
{
    ...
    public class HospitalsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAsync()
        {
            ...
            return Ok(_mapper.Map<List<Orchestrators.Hospitals.Hospital>>(entity));
        }
        ...
        public async Task<IActionResult> GetByIdAsync(int id)
        {
            ...
            return Ok(_mapper.Map<Orchestrators.Hospitals.Hospital>(Hospitals));
        }
        [HttpPost ("{id}")]
        public async Task<IActionResult> PostAsync(Orchestrators.Hospitals.Hospital hospital)
        {
            var bankModel = _mapper.Map<Core.Hospitals.Hospital>(hospital);
            var createdModel = await _service.AddHospitalAsync(bankModel);
            return Ok(_mapper.Map<Data.Hospitals.Hospital>(createdModel));
        }
        [HttpPatch("{id}")]
